                ...
                >
                  <AccordionTrigger className="bg-gray-200 py-3 grid grid-cols-7 gap-4 font-bold text-black text-sm px-3">
                    <div className="col-span-3 col-start-1 flex items-center gap-2">
                      <span className="text-base text-black">{module.title}</span>
                    ...
                    <span className="col-span-3 col-start-4 text-base text-black">
                      {moduleProgress
                        ? `${moduleProgress.completed}/${moduleProgress.total} hoàn thành`
                            ...
                            (curriculum.lectures ?? []).map((lecture) => {
                              ...
                              return (
                                <div
                                  ...
                                  className="flex justify-between items-center text-base text-black pl-4 py-1"
                                >
