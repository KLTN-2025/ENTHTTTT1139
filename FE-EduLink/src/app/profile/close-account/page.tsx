              ...
              <div className="mb-8">
                <div className="border border-gray-300 rounded-lg bg-white py-6 px-5">
                  ...
                  <div className="flex justify-start mt-6">
                    <button className="bg-[#00FF84] hover:bg-[#00FF84]/80 text-black py-2 px-4 rounded-lg shadow-custom transition-colors duration-300 w-[157px] text-sm font-semibold">
                      Đóng tài khoản
                    </button>
                  </div>
                </div>
